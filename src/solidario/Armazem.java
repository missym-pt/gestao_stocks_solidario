...
public class Armazem {
    ...
    private Tipo_armazem tipo_armazem;
    private Estado estado;
    private String data_estado_armazem;
    
    public Armazem(int id_armazem,String nome_armazem, Localizacao local, Funcionario responsavel_de_armazem, Tipo_armazem tipo_armazem, Estado estado, String data_estado_armazem){
    ...
    public Tipo_armazem getTipo_armazem() {
        return tipo_armazem;
    }

    public void setTipo_armazem(Tipo_armazem tipo_armazem) {
        this.tipo_armazem = tipo_armazem;
    }
